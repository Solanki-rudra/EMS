...
function FailedTask({task}) {
  return (
    <div className='p-5 flex-shrink-0 rounded-xl bg-yellow-400 min-h-fit min-w-fit h-[350px] w-[25%]'>
        ...
        <button disabled className='bg-red-600 w-full my-4 rounded-md p-1 px-2 text-sm font-bold'>Fail</button>
    </div>
  )
}
