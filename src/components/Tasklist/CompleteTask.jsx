...
function CompleteTask({task}) {
  return (
    <div className='p-5 flex-shrink-0 rounded-xl bg-blue-400 min-h-fit min-w-fit h-[350px] w-[25%]'>
    ...
    <p className='font-semibold text-md'>{task.taskDescription}</p>
          <button disabled className='bg-green-600 w-full my-4 rounded-md p-1 px-2 text-sm font-bold'>Complete</button>
</div>
  )
}
